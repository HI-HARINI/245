...
infura_url = 'https://mainnet.infura.io/v3/d5645dd087c543cb82c2ac902e485ada'
...
def ethereum_block():
    ...
    value_in_dollars = value_in_ether*1867.56

    gas = transaction["gas"]
    gasused_info_label["text"] = "Value: $" + str(value_in_dollars)
    gaslimit_info_label["text"] = "Gas: $" + str(gas)
    block_name_label["text"] = "Block Entry Name" + block_entry.get()
